...
import org.aiwolf.sample.player.SampleFoxTmp;
import org.aiwolf.sample.player.SampleImmoralistTmp;
...
public abstract class AbstractRoleAssignPlayer implements Player {
	...
	private Player foxPlayer = new SampleFoxTmp();
	private Player immoralistPlayer = new SampleImmoralistTmp();
	...
	/**
	 * <div lang="ja">妖狐用プレイヤーを返す．</div>
	 *
	 * <div lang="en">Returns the player actually used in case of fox.</div>
	 * 
	 * @return <div lang="ja">妖狐用プレイヤー</div>
	 *
	 *         <div lang="en">the player actually used in case of fox</div>
	 */
	public final Player getFoxPlayer() {
		return foxPlayer;
	}

	/**
	 * <div lang="ja">妖狐用プレイヤーをセットする．</div>
	 *
	 * <div lang="en">Sets the player actually used in case of fox.</div>
	 * 
	 * @param foxPlayer
	 *            <div lang="ja">実際の妖狐プレイヤー</div>
	 *
	 *            <div lang="en">the actual fox player</div>
	 */
	public final void setFoxPlayer(Player foxPlayer) {
		this.foxPlayer = foxPlayer;
	}

	/**
	 * <div lang="ja">背徳者用プレイヤーを返す．</div>
	 *
	 * <div lang="en">Returns the player actually used in case of immoralist.</div>
	 * 
	 * @return <div lang="ja">背徳者用プレイヤー</div>
	 *
	 *         <div lang="en">the player actually used in case of immoralist</div>
	 */
	public final Player getImmoralistPlayer() {
		return immoralistPlayer;
	}
	
	/**
	 * <div lang="ja">背徳者用プレイヤーをセットする．</div>
	 *
	 * <div lang="en">Sets the player actually used in case of immoralist.</div>
	 * 
	 * @param immoralistPlayer
	 *            <div lang="ja">実際の背徳者プレイヤー</div>
	 *
	 *            <div lang="en">the actual immoralist player</div>
	 */
	public final void setImmoralistPlayer(Player immoralistPlayer) {
		this.immoralistPlayer = immoralistPlayer;
	}
	...
	public final void initialize(GameInfo gameInfo, GameSetting gameSetting) {
		...
		case WEREWOLF:
			...
			break;
		case FOX:
			rolePlayer = foxPlayer;
			break;
		case IMMORALIST:
			rolePlayer = immoralistPlayer;
			break;
		default:
			rolePlayer = villagerPlayer;
			break;
